...
Agentic AI Needs System Theory (https://arxiv.org/pdf/2503.00237)

Why Do Multi-Agent Systems Fail? (https://arxiv.org/abs/2503.13657)

Stochasticity in Agentic Evals (https://arxiv.org/html/2512.06710v1)

The Multi-Agent Off-Switch Game (https://ebadian.org/preprint/multiagent_offswitch_cr.pdf)

Emergent Social Conventions and Bias in LLM Popuplations (https://researchprofiles.ku.dk/en/publications/emergent-social-conventions-and-collective-bias-in-llm-population/)
